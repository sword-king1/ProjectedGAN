    ...
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_c, gain, cur_nimg):
        ...
        if do_Gmain:
            ...
            with torch.autograd.profiler.record_function('Gmain_forward'):
                print("#loss:accumulate_gradients in", phase)
        ...
        if do_Dmain:
            ...
            with torch.autograd.profiler.record_function('Dgen_forward'):
                ...
                print("loss_Dgen==1", loss_Dgen)
                # Logging
                training_stats.report('Loss/scores/fake', gen_logits)
                training_stats.report('Loss/signs/fake', gen_logits.sign())

            with torch.autograd.profiler.record_function('Dgen_backward'):
                for _, p in trainable_parameters(D):
                    print(p.grad_sample)
                print("loss_Dgen==2", loss_Dgen)
                loss_Dgen.backward()
                print("loss:endDmain---------2.5")
            ...
            with torch.autograd.profiler.record_function('Dreal_forward'):
                ...
                #print("++++++++++++++++++++++loss1+++++++++++++++++++++++++++++++")
                loss1=F.relu(torch.ones_like(real_logits) - real_logits)
                #print(loss1)
                #print("++++++++++++++++++++++loss1++++++++++++++++++++++++++++++")
                loss_Dreal = loss1.mean()
                print("++++++++++++++++++++loss_Dreal+++++++++++++++++++++++++++++++++")
                print(loss_Dreal)
                print("++++++++++++++++++++++loss_Dreal+++++++++++++++++++++++++++++++")
